      ...
      <div style="margin-top: 15px">
        ...
        <el-form-item label="设备类型" class="label-css">
          ...
          <el-form-item label="状态" class="label-css">
            <el-select v-model="listQuery.saStatus" class="input-width" placeholder="全部" clearable>
    ...
    <div class="table-container">
      <el-table ref="orderTable"
        ...
        <el-table-column label="设备类型" width="120" align="center">
          <template slot-scope="scope">{{scope.row.sa_type.name}}</template>
        </el-table-column>
        ...
        <el-table-column label="签收人" width="120" align="center">
          <template slot-scope="scope">{{scope.row.signerUser.name   }}</template>
        </el-table-column>
        ...
        <el-table-column label="资产归属" width="120" align="center">
          <template slot-scope="scope">{{scope.row.bank.name}}</template>
        </el-table-column>
