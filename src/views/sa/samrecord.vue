<template>
      ...
      <el-card class="filter-container" shadow="never">
        ...
        <el-row>
          <el-col span="10">
                  <el-form-item label="资产类型" class="label-css">
                      <el-select v-model="listQuery.saType" class="input-width" placeholder="全部" clearable>
          ...
          <el-col span="10">
            <el-form-item label="资产编号" class="label-css">
                <el-input v-model="listQuery.saSerialNum" size="medium"></el-input>
              </el-form-item>  
       ...
       <el-row>
        <el-col span="15">
              ...
              <el-form-item label="维修时间" class="label-css">
                <el-date-picker
                  class="picker-width"
                  v-model="listQuery.m_start"
      ...
      <div class="table-container">
        <el-table ref="orderTable"
          ...
          <el-table-column label="设备名称" width="180" align="center">
            <template slot-scope="scope">{{scope.row.sa_name}}</template>
          </el-table-column>
          <el-table-column label="设备类型" width="180" align="center">
            <template slot-scope="scope">{{scope.row.satype_name}}</template>
          </el-table-column>
          <el-table-column label="维修厂家" width="180" align="center">
  ...
  <script>
    ...
    import {fetchRecordList} from '@/api/sam'
