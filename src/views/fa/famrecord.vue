<template>
        ...
        <el-row>
          ...
          <el-col span="10">
            <el-form-item label="资产编号" class="label-css">
                <el-input v-model="listQuery.faSerialNum" size="medium"></el-input>
              </el-form-item>  
      ...
      <div class="table-container">
        <el-table ref="orderTable"
          ...
          <el-table-column label="设备名称" width="180" align="center">
            <template slot-scope="scope">{{scope.row.fassetName}}</template>
          </el-table-column>
          <el-table-column label="设备类型" width="180" align="center">
            <template slot-scope="scope">{{scope.row.fatypeName}}</template>
          </el-table-column>
          ...
          <el-table-column label="审核人" width="120" align="center">
            <template slot-scope="scope">{{scope.row.reviewUserName}}</template>
          </el-table-column>
  ...
  <script>
    ...
    import {fetchRecordList} from '@/api/fam'
